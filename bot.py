...
# ────────────── YouTube URL 재생 ──────────────
@tree.command(name="youtube", description="유튜브 링크 재생")
...
# ────────────── YouTube 검색 재생 ──────────────
@tree.command(name="yt검색", description="검색어 입력 시 유튜브에서 찾아 자동 재생")
...
# ────────────── 정지 명령어 ──────────────
@tree.command(name="정지", description="라디오/유튜브 재생을 멈추고 음성채널 나가기")
